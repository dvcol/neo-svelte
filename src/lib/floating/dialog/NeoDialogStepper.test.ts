...
import Harness from './NeoDialogStepperHarness.test.svelte';
...
describe('neoDialogStepper — render', () => {
...
describe('neoDialogStepper — navigation', () => {
...
describe('neoDialogStepper — closable matrix', () => {

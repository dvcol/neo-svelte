...
import Harness from './NeoDialogConfirmHarness.test.svelte';
...
describe('neoDialogConfirm — render', () => {
...
describe('neoDialogConfirm — closable matrix', () => {
...
describe('neoDialogConfirm — onCancel / onConfirm', () => {

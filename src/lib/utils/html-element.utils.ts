...
export interface HTMLRefProps<T extends HTMLElement = HTMLElement> {
  /**
...
export interface HTMLTagProps<T extends keyof HTMLElementTagNameMap = keyof HTMLElementTagNameMap> {
  /**
...
export interface HTMLFlexProps {
  /**
